...
# 'sqlite:///app.db'  # This will create 'app.db' file in the current directory
app.config['SQLALCHEMY_DATABASE_URI'] = os.environ.get('DATABASE_URL')  # Use the environment variable
